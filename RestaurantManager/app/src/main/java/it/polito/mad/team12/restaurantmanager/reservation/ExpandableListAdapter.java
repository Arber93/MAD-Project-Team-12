...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        btn_accept.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // TODO move this header to the ACCEPTED LIST
                // check that each tab shows the correct and updated list of reservations (consider
                // all the possible cases of onSomething)
        ...
        btn_deny.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // TODO move this header to the DENIED LIST
    ...
    private void putReservation(int request) {
        // jsonString has all the reservations and their details
