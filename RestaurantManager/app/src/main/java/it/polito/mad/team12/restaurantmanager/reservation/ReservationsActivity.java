...
public class ReservationsActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new PendingReservationsFragment(), PENDING);
        adapter.addFragment(new AcceptedReservationsFragment(), ACCEPTED);
        adapter.addFragment(new DeniedReservationsFragment(), HISTORY);
